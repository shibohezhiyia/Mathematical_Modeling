"""Re-run the consumed v16 cases after product-angle rational composition."""
...
def main() -> int:
    ...
    parser.add_argument("--output", default=(
        "artifacts/llm-srbench-pilot/v16-post-product-angle-development.json"))
    args = parser.parse_args()
    cases = load_llm_srbench_cases(
        args.dataset_dir, instance_ids=V16_IDS, source_revision=args.source_revision,
        train_limit=512, test_limit=256, seed=20261006,
    )
    ...
    report = run_llm_srbench_comparison(
        ...
        schema_version="mathmodel.llm-srbench-product-angle-development/v1",
    )
    report["status"] = "development_only_after_v16_truth_inspection"
    report["policy"] += ";consumed_v16_cases;not_confirmation"
