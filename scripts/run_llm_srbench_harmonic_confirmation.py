"""Freeze a new LLM-SRBench grid for harmonic rational-composition ablation."""
...
V15_IDS = (
    "lsr_transform_i.10.7_1_0", "lsr_transform_ii.34.2_1_0",
    "lsr_transform_i.29.16_1_0", "lsr_transform_i.15.1_1_0",
    "lsr_transform_ii.15.5_1_0", "lsr_transform_i.34.1_2_0",
    "lsr_transform_i.37.4_0_1", "lsr_transform_iii.15.27_2_0",
)
...
def main() -> int:
    ...
    parser.add_argument("--output", default=(
        "artifacts/llm-srbench-confirmation/community-mirror-harmonic-20261005.json"))
    parser.add_argument("--registry-dir", default="artifacts/modeling-confirmation/consumed")
    args = parser.parse_args()
    protocol = "llm-srbench-harmonic-confirmation-v15"
    ...
    methods = ("harmonic-rational-composition/v15",
               "without-harmonic-rational-composition/v15")
    ...
    selected = select_llm_srbench_instances(
        ...
        exclude=(*DEVELOPMENT_IDS, *V11_IDS, *V12_IDS, *V13_IDS, *V14_IDS), maximum_arity=4,
    )
    ...
    report = run_llm_srbench_comparison(
        ...
        treatment_payload={**common, "enable_harmonic_trigonometric_features": True},
        baseline_payload={**common, "enable_harmonic_trigonometric_features": False},
        schema_version="mathmodel.llm-srbench-harmonic-comparison/v1",
    )
    ...
    report["confirmation_protocol"] = {
        ...
        "scope": "community_mirror;hash_selection_before_truth_load;prior_37_cases_excluded;harmonic_rational_composition_ablation",
    }
