"""Freeze a new grid for transformed power-law and Laurent-root ablation."""
...
V14_IDS = (
    "lsr_transform_iii.17.37_1_0", "lsr_transform_iii.13.18_0_0",
    "lsr_transform_i.34.14_2_0", "lsr_transform_iii.21.20_2_0",
    "lsr_transform_ii.13.23_1_0", "lsr_transform_ii.11.27_1_0",
    "lsr_transform_iii.21.20_3_0", "lsr_transform_ii.6.15b_1_0",
)
...
def main() -> int:
    ...
    parser.add_argument("--output", default="artifacts/llm-srbench-confirmation/community-mirror-transformed-power-20261004.json")
    parser.add_argument("--registry-dir", default="artifacts/modeling-confirmation/consumed")
    args = parser.parse_args()
    protocol = "llm-srbench-transformed-power-confirmation-v14"
    ...
    methods = ("transformed-power-laurent/v14", "without-transformed-power-laurent/v14")
    ...
    selected = select_llm_srbench_instances(
        ...
        exclude=(*DEVELOPMENT_IDS, *V11_IDS, *V12_IDS, *V13_IDS), maximum_arity=4,
    )
    ...
    report = run_llm_srbench_comparison(
        cases, treatment_name="transformed_power_laurent",
        baseline_name="without_transformed_power_laurent",
        ...
        baseline_payload={"enable_multivariate_nonlinear": True,
                          "enable_trigonometric_rational_features": True,
                          "enable_extended_multivariate_composition": True,
                          "enable_transformed_power_laurent": False},
        schema_version="mathmodel.llm-srbench-transformed-power-comparison/v1",
    )
    ...
    report["confirmation_protocol"] = {
        ...
        "scope": "community_mirror;hash_selection_before_truth_load;prior_29_cases_excluded;transformed_power_laurent_ablation",
    }
